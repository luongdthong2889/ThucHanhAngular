...
export class MobilePhoneService{
    ...
    mobilePhones:MobilePhone[]=[
        ...
        new MobilePhone("MB0002","Samsung S21",1000,"Hiệu năng khủng từ \"quái vật\" Snapdragon 888"),
        new MobilePhone("MB0003","Redmi Note 10S",800,"Hiệu năng khủng từ \"quái vật\" Helio G95"),
      ];
    constructor(){}
    getMobilePhones(){
